...
const About = () => {
    ...
    return (
        <section className="pt-[8rem] mb-[5rem]" id="about">
                ...
                <AnimateInView initialVal={100}>
                    ...
                    <div className="flex flex-col gap-5 text-[1.2rem] font-[400]">
                        ...
                        <p>
                            ...
                            effectively with cross-functional teams sets me
                            apart. I'm passionate about delivering top-notch web
                            solutions and am eager to contribute my skills to
                            your projects.
                        </p>
                    </div>
